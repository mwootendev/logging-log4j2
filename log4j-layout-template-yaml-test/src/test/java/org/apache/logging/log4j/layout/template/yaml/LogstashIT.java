...
import co.elastic.clients.yaml.jackson.JacksonYamlpMapper;
...
import org.apache.logging.log4j.layout.template.structured.util.ThreadLocalRecyclerFactory;
...
class LogstashIT {
    ...
    private static final YamlTemplateLayout JSON_TEMPLATE_GELF_LAYOUT = YamlTemplateLayout.newBuilder()
            .setConfiguration(CONFIGURATION)
            .setCharset(CHARSET)
            .setEventTemplateUri("classpath:GelfLayout.yaml")
            .setEventDelimiter("\0")
    ...
    private static final YamlTemplateLayout JSON_TEMPLATE_ECS_LAYOUT = YamlTemplateLayout.newBuilder()
            .setConfiguration(CONFIGURATION)
            .setCharset(CHARSET)
            .setEventTemplateUri("classpath:EcsLayout.yaml")
    ...
    static void initEsClient() {
        ...
        ES_TRANSPORT = new RestClientTransport(REST_CLIENT, new JacksonYamlpMapper());
    ...
    void test_GelfLayout() throws IOException {
        ...
        // Collect documents created by `YamlTemplateLayout`

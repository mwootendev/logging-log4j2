...
class RecyclerFactoriesTest {
    ...
    @Test
    @LoggerContextSource("recyclerFactoryCustomizedYamlTemplateLayoutLogging.xml")
    void test_RecyclerFactoryConverter_using_XML_config(final @Named(value = "List") ListAppender appender)
            throws Exception {
        final YamlTemplateLayout layout = (YamlTemplateLayout) appender.getLayout();
        final Field field = YamlTemplateLayout.class.getDeclaredField("contextRecycler");

...
@Tag("allocation")
@Tag("functional")
public class YamlTemplateLayoutGcFreeTest {
    ...
    public static void main(final String[] args) throws Exception {
        System.setProperty("log4j.layout.yamlTemplate.recyclerFactory", "threadLocal");
        System.setProperty("log4j2.garbagefree.threadContextMap", "true");
        System.setProperty("log4j2.clock", "SystemMillisClock");
        GcFreeLoggingTestUtil.executeLogging("gcFreeYamlTemplateLayoutLogging.xml", YamlTemplateLayoutGcFreeTest.class);
    }
}

...
class YamlTemplateLayoutAdditionalFieldTest {

    @Test
    @LoggerContextSource("additionalFieldEnrichedYamlTemplateLayoutLogging.yaml")
    ...
    @Test
    @LoggerContextSource("additionalFieldEnrichedYamlTemplateLayoutLogging.properties")
    ...
    @Test
    @LoggerContextSource("additionalFieldEnrichedYamlTemplateLayoutLogging.xml")
    ...
    private static void assertAdditionalFields(final LoggerContext loggerContext, final ListAppender appender) {
        ...
        // Log an event.
        final Logger logger = loggerContext.getLogger(YamlTemplateLayoutAdditionalFieldTest.class);
        logger.info("trigger");
        ...
        final String serializedEventYaml = new String(serializedEvent, YamlTemplateLayoutDefaults.getCharset());
        final Object serializedEventObject = JacksonFixture.getObjectMapper().readValue(serializedEventYaml);

...
import static org.apache.logging.log4j.layout.template.yaml.TestHelpers.JAVA_BASE_PREFIX;
...
import org.apache.logging.log4j.layout.template.yaml.YamlTemplateLayoutDefaults;
import org.apache.logging.log4j.layout.template.structured.util.TruncatingBufferedPrintWriter;
...
class StackTraceStringResolverTest {
    ...
    private abstract static class AbstractTestCases {
        ...
        private static void assertSerializedException(
            ...
            final String eventTemplate = writeYaml(asMap("output", exceptionResolverTemplate));
    ...
    class WithoutTruncation extends AbstractTestCases {
        ...
        @Test
        void YamlWriter_maxStringLength_should_work() {
            ...
            usingSerializedLogEventAccessor(layout, logEvent, accessor -> {
                final int expectedLength = maxStringLength
                        + YamlTemplateLayoutDefaults.getTruncatedStringSuffix().length();
    ...
    class WithTruncation extends AbstractTestCases {
        ...
        void should_not_fail_on_truncated_output_not_ending_with_newline() {
            ...
            final float maxByteCountPerChar =
                    YamlTemplateLayoutDefaults.getCharset().newEncoder().maxBytesPerChar();

...
import org.apache.logging.log4j.layout.template.structured.util.CharSequencePointer;
...
final class StackTraceStringResolver implements StackTraceResolver {
    ...
    @Override
    public void resolve(final Throwable throwable, final StructuredWriter jsonWriter) {

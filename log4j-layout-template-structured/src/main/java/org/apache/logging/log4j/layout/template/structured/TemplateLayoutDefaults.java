...
public final class TemplateLayoutDefaults {

    private TemplateLayoutDefaults() {}
    ...
    public static String getEventTemplateUri() {
        return PROPERTIES.getStringProperty("log4j.layout.template.eventTemplateUri", "classpath:EcsLayout.json");
    }
    ...
    public static String getStackTraceElementTemplateUri() {
        return PROPERTIES.getStringProperty(
                "log4j.layout.template.stackTraceElementTemplateUri", "classpath:StackTraceElementLayout.json");
    }

...
import org.apache.logging.log4j.layout.template.structured.TemplateLayoutDefaults;
import org.apache.logging.log4j.layout.template.structured.TemplateLayoutDefaults;
 ...
 * TemplateLayoutDefaults.Builder#setStackTraceEnabled(boolean) stackTraceEnabled}
 ...
 * template can also be provided using {@link TemplateLayoutDefaults.Builder#setStackTraceElementTemplate(String) stackTraceElementTemplate}
 * and {@link TemplateLayoutDefaults.Builder#setStackTraceElementTemplateUri(String) setStackTraceElementTemplateUri}
 ...
 * </pre>
 *
 * @see TemplateLayoutDefaults.Builder#getTruncatedStringSuffix()
 * @see TemplateLayoutDefaults#getTruncatedStringSuffix()
 * @see TemplateLayoutDefaults.Builder#getStackTraceElementTemplate()
 * @see TemplateLayoutDefaults#getStackTraceElementTemplate()
 * @see TemplateLayoutDefaults.Builder#getStackTraceElementTemplateUri()
 * @see TemplateLayoutDefaults#getStackTraceElementTemplateUri()
...
public class ExceptionResolver implements EventResolver {
    ...
    private EventResolver createClassNameResolver() {
        return (final LogEvent logEvent, final StructuredWriter jsonWriter) -> {
    ...
    private static TemplateResolver<StackTraceElement> createStackTraceElementResolver(
        ...
        final StackTraceElementResolverContext stackTraceElementResolverContext =
                StackTraceElementResolverContext.newBuilder()
                        ...
                        .setStructuredWriter(context.getStructuredWriter())
                        .build();
    ...
    private static String findEffectiveStackTraceElementTemplate(
        ...
        if (stackTraceElementTemplateObject != null) {
            final StructuredWriter jsonWriter = context.getStructuredWriter();
    ...
    @Override
    public void resolve(final LogEvent logEvent, final StructuredWriter jsonWriter) {

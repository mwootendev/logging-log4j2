 ...
 * {@link TemplateLayoutDefaults#getLocale()}, which is configured by
...
public final class CaseConverterResolver implements EventResolver {
    ...
    @Override
    public void resolve(final LogEvent logEvent, final StructuredWriter jsonWriter, final boolean succeedingEntry) {
        final int startIndex = jsonWriter.getStringBuilder().length();
        inputResolver.resolve(logEvent, jsonWriter, succeedingEntry);
        convertCase(logEvent, jsonWriter, startIndex);
    }

    private void convertCase(final LogEvent logEvent, final StructuredWriter jsonWriter, final int startIndex) {
    ...
    private void convertCase(
            final LogEvent logEvent, final StructuredWriter jsonWriter, final int startIndex, final String json) {
        final StringBuilder jsonWriterStringBuilder = jsonWriter.getStringBuilder();
        final String string = (String) StructuredReader.read(json);

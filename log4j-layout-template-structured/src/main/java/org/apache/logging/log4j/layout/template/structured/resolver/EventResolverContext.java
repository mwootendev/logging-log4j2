...
public final class EventResolverContext implements TemplateResolverContext<LogEvent, EventResolverContext> {
    ...
    private final StructuredWriter jsonWriter;
    ...
    @Override
    public StructuredWriter getStructuredWriter() {
        return jsonWriter;
    }
    ...
    public static class Builder {
        ...
        public Builder setStructuredWriter(final StructuredWriter jsonWriter) {

...
import org.apache.logging.log4j.layout.template.structured.util.StructuredReader;
...
public final class TemplateResolvers {
    ...
    private static final class EmptyArrayResolver extends UnresolvableTemplateResolver {
        ...
        @Override
        public void resolve(final Object value, final StructuredWriter jsonWriter) {
    ...
    public static <V, C extends TemplateResolverContext<V, C>> TemplateResolver<V> ofTemplate(
        ...
        Object node;
        try {
            node = StructuredReader.read(template);
    ...
    private static final class ArrayResolver<V> implements TemplateResolver<V> {
        ...
        @Override
        public void resolve(final V value, final StructuredWriter jsonWriter) {
            jsonWriter.writeArrayStart();
    ...
    private static <V, C extends TemplateResolverContext<V, C>>
        ...
        final List<String> fieldPrefixes = fieldNames.stream()
                .map(fieldName -> {
                    try (final StructuredWriter jsonWriter = context.getStructuredWriter()) {
    ...
    private interface FieldResolverMethod<V> {
        ...
        boolean resolve(V value, StructuredWriter jsonWriter, boolean succeedingEntry);
    }
    ...
    private static final class FlatteningFieldResolverMethod<V> implements FieldResolverMethod<V> {
        ...
        @Override
        public boolean resolve(final V value, final StructuredWriter jsonWriter, final boolean succeedingEntry) {
    ...
    private static <V, C extends TemplateResolverContext<V, C>> TemplateResolver<V> ofString(
        ...
        final StructuredWriter contextStructuredWriter = context.getStructuredWriter();
            ...
            if (substitutor.isStable()) {
                ...
                if (replacedText == null) {
                    ...
                    final String escapedReplacedText =
                            contextStructuredWriter.use(() -> contextStructuredWriter.writeString(replacedText));
        ...
        // Write the field value as is.
            ...
            final String escapedFieldValue = contextStructuredWriter.use(() -> contextStructuredWriter.writeString(fieldValue));
    ...
    private static final class RawStringResolver<V> implements TemplateResolver<V> {
        ...
        @Override
        public void resolve(final V ignored, final StructuredWriter jsonWriter) {

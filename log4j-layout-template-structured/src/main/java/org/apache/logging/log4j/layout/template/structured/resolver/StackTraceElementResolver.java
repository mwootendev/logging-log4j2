...
final class StackTraceElementResolver implements TemplateResolver<StackTraceElement> {
    ...
    private static final TemplateResolver<StackTraceElement> CLASS_NAME_RESOLVER =
            (final StackTraceElement stackTraceElement, final StructuredWriter jsonWriter) ->
    ...
    @Override
    public void resolve(final StackTraceElement stackTraceElement, final StructuredWriter jsonWriter) {

...
public final class MessageResolver implements EventResolver {
    ...
    private static EventResolver createStringResolver() {
        return (final LogEvent logEvent, final StructuredWriter jsonWriter) -> resolveString(null, logEvent, jsonWriter);
    }

    private static void resolveString(final String fallbackKey, final LogEvent logEvent, final StructuredWriter jsonWriter) {
        final Message message = logEvent.getMessage();
        resolveString(fallbackKey, message, jsonWriter);
    }

    private static void resolveString(final String fallbackKey, final Message message, final StructuredWriter jsonWriter) {
        if (fallbackKey != null) {
    ...
    private static boolean writeMultiformatMessage(final StructuredWriter jsonWriter, final Message message) {
    ...
    private static boolean writeObjectMessage(final StructuredWriter jsonWriter, final Message message) {

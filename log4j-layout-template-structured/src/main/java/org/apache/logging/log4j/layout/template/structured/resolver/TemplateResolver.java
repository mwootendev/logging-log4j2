...
public interface TemplateResolver<V> {
    ...
    /**
     * Resolves the given {@code value} using the provided {@link StructuredWriter}.
     */
    void resolve(V value, StructuredWriter jsonWriter);
     ...
     */
    default void resolve(final V value, final StructuredWriter jsonWriter, final boolean succeedingEntry) {

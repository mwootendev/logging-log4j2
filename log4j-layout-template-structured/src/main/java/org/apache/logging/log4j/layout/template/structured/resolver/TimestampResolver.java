 ...
 * There {@link TemplateLayoutDefaults#getTimestampFormatPattern()}, {@link TemplateLayoutDefaults#getTimeZone()}, {@link TemplateLayoutDefaults#getLocale()} are used as defaults for <tt>pattern</tt>, <tt>timeZone</tt>, and <tt>locale</tt>, respectively.
 * </p>
 *
 * <p>
...
public final class TimestampResolver implements EventResolver {
    ...
    private static String readPattern(final TemplateResolverConfig config) {
        ...
        return format != null ? format : TemplateLayoutDefaults.getTimestampFormatPattern();
    }
    ...
    private static TimeZone readTimeZone(final TemplateResolverConfig config) {
        ...
        if (timeZoneId == null) {
            return TemplateLayoutDefaults.getTimeZone();
        }
        boolean found = false;

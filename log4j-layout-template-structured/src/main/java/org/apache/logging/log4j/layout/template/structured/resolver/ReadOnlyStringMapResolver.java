...
class ReadOnlyStringMapResolver implements EventResolver {
    ...
    private static EventResolver createResolver(
        ...
        return new EventResolver() {
            ...
            @Override
            public void resolve(final LogEvent value, final StructuredWriter jsonWriter) {
            ...
            public void resolve(final LogEvent logEvent, final StructuredWriter jsonWriter, final boolean succeedingEntry) {
                ...
                loopContext.initStructuredWriterStringBuilderLength =
    ...
    private static final class LoopContext {
        ...
        private StructuredWriter jsonWriter;

        private int initStructuredWriterStringBuilderLength;
